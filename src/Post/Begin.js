	...
	<div className="row">
		...
		<div className="col-md-2 col-xs-12">
			<div className="share">
				...
				<ul>
					<li>
					<a href="https://twitter.com/home?status=http%3A//www.wowthemes.net">
					...
					<li>
					<a  href="https://www.facebook.com/sharer/sharer.php?u=http%3A//www.wowthemes.net">
			...
			<div className="mainheading">
				...
				<div className="row post-top-meta">
					...
					<div className="col-md-10">
						<NavLink className="link-dark" to="/author">Sal</NavLink><a  className="btn follow">Follow</a>
